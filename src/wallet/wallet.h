...
public:
    ...
    // Coin selection
    bool SelectCoinsByDenominations(int nDenom, CAmount nValueMin, CAmount nValueMax, std::vector<CTxIn>& vecTxDSInRet, std::vector<COutput>& vCoinsRet, CAmount& nValueRet);
