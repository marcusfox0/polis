...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("polis.org", "dnsseed.polis.org"));
        vSeeds.push_back(CDNSSeedData("polisdot.io", "dnsseed.polisdot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("polispay.io", "dnsseed.polispay.io"));

        // Polis addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,76);
        // Polis script addresses start with '7'
