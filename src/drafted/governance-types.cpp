...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PolisNetwork") type = PolisNetwork;
    if(strType == "PolisNetworkVariable") type = PolisNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PolisNetwork) s = "PolisNetwork";
    if(type == PolisNetworkVariable) s = "PolisNetworkVariable";
